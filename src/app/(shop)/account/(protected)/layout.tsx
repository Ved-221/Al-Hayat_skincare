  ...
  return (
    <div className="min-h-screen bg-[#fff8f1] pt-[90px] pb-20">
      <div className="mx-auto max-w-6xl px-4 w-full flex-1">
        ...
        <div className="md:hidden mb-6 flex items-center justify-between bg-white p-4 rounded-2xl shadow-sm border border-[#c8c7b5]/30">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-72 shrink-0 space-y-6">
            ...
            {/* Navigation Menu */}
            <div className="bg-white rounded-3xl border border-[#c8c7b5]/30 p-3 shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
              <nav className="flex flex-col gap-1">
                <Link href="/account" className="flex items-center gap-3 text-sm font-semibold text-[#434b01] hover:text-[#5a6401] hover:bg-[#faf3ea]/70 px-4 py-3 rounded-2xl transition-all">
                  <LayoutDashboard size={18} className="text-[#787868]" />
                  Overview
                </Link>
                <Link href="/account/orders" className="flex items-center gap-3 text-sm font-semibold text-[#434b01] hover:text-[#5a6401] hover:bg-[#faf3ea]/70 px-4 py-3 rounded-2xl transition-all">
                  <ShoppingBag size={18} className="text-[#787868]" />
                  Order History
                </Link>
                <Link href="/account/wishlist" className="flex items-center gap-3 text-sm font-semibold text-[#434b01] hover:text-[#5a6401] hover:bg-[#faf3ea]/70 px-4 py-3 rounded-2xl transition-all">
                  <Heart size={18} className="text-[#787868]" />
                  Wishlist
                </Link>
                
                <div className="h-px bg-[#c8c7b5]/20 my-2 mx-2"></div>
                
                <form action={logoutAction} className="w-full">
                  <button 
                    type="submit"
                    className="flex items-center gap-3 text-sm font-semibold text-[#b22a2b] hover:bg-red-50 px-4 py-3 rounded-2xl transition-all w-full"
                  >
                    <LogOut size={18} />
                    Sign Out
                  </button>
            ...
            {/* Help Block */}
            <div className="bg-[#434b01] rounded-3xl p-6 text-white text-center shadow-md relative overflow-hidden">
