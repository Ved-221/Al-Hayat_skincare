              ...
              {[
                {
                  ...
                  sub: "Cleanse naturally",
                  img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAOD6xQB4tgGP5Ns4WZ-fe7t4LotJ-nSIk6HEtdVGe1YTrwpfPpClHH4Vofpgp18A1bQLQH03ASysbJqGzZZZPyYp96yMaQxHVfgexiksxMwWuJMe0Y9vJ0aitKXmcBzbl6Wqt4dknyau-87HrXmSR096wlTR3W7hf9A6CJIabdQGkAhmyEysZQKTUwEQuEH5TNyOTaXdtz7QOSro4DuhSZdVZCX0hIZUDT-91-TZXdZOA88qCYc7EphNw2wgVnZcXKL-k8Sh2g9WXA",
                  href: "/products?category=soaps",
                },
                {
                  label: "Face Care",
                  sub: "Glow from within",
                  img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAnFMbR2otWYUlJ4YAmNGAA_fy1sL669LbEmR9szDxDMcDvvckpVGGgHsFxb74VnEV6IzzygCBqi5u-Maeo-3KdNtnNtR5CvB8jKXw57FLR1vr38h5SgNWPq6GGOe5nnakU5okAshV_g7ymRNO5roRVRh_rNexHUefTXx7tD8tAMde3p4oU2KiWopDpcZsvw6xiZrn0rgMVBVWve4uk_7ilf0w6U2YEjsy1hF6ZeK5zQo_Tw4iSijB0VMIFfbdYUAyKZXgB49LcTfl7",
                  href: "/products?category=face",
                },
                {
                  label: "Hair Care",
                  sub: "Nourish every strand",
                  img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCI-qyukqL0yeJ0O-lHjG4mSVuVjiExQtib2r9RnEgyLFN7lE7tEgbMYSMVrGjLivdN1wpc4isr7vvkGII9Zxe8tUa5Fa4vADugFm-_Zu8_u7LYHQjzZIQg1qCiSv_twT24mNXYVMhD46UeN5mj7WzVNKQlc0ai5Npg69EnivLp94_sGLDxBypywK5UeEKqeFlplyFG2c57od1AdxbRer9L34gzMQ14W3v7DPEdp2pNlkbWS7yQLw3umtyLKaahTnVmw3A6FHuCBn8y",
                  href: "/products?category=hair",
                },
                {
                  label: "Lip Care",
                  sub: "Petal-soft lips",
                  img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDFUu_YuBv6SS4FwcKLGEMAoGuWgI_DxuXVXgKMxTVQlIXle2Tz5OHhfL_G9m2v__-2OO9-AmRnmGeiNV-O54c-0Ql01jsdkyFmd2pAHQ9E9Zf2HJR86yfljXq7OO5TslW4KeYVy239F6sr1dyQDMEe8HCxymN7KpkwiJNqAKiB_CH-jaEsu0_NsQJ6XCAC0hPjCdlZIP4h4GDF6ZeNMk7ukzwnvrS2pR5mVkgKdsZlNuOLAiH3FC6ACsVPzglKu6kVB-SZqfwFz7jf",
                  href: "/products?category=lip",
                },
              ].map((cat) => (
                <Link key={cat.label} href={cat.href} className="group block" style={{ textDecoration: "none" }}>
                  <div
                    className="relative overflow-hidden"
                    style={{ borderRadius: "100px 100px 12px 12px", aspectRatio: "3/4", background: "#EAE2D1" }}
                  >
                    <img
                      src={cat.img}
                      alt={cat.label}
                    ...
                    <div className="absolute bottom-4 left-0 right-0 text-center">
                      ...
                      <span
                        ...
                        style={{ fontFamily: "'Inter', sans-serif", fontSize: "10px", letterSpacing: "0.08em", marginTop: "2px" }}
                      >
                        {cat.sub}
                      </span>
                    </div>
